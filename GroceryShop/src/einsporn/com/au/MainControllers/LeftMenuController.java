...
public class LeftMenuController {
    ...
    @FXML
    public void shopPageBtnHandle() throws IOException {
    ...
    @FXML
    public void CustomerPageBtnHandle() throws IOException {
    ...
    @FXML
    public void productPageBtnHandler() throws IOException {
    ...
    @FXML
    public void supplierPageBtnHandler() throws IOException {
    ...
    @FXML
    public void salesPageBtnHandler() throws IOException {
