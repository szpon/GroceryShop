package einsporn.com.au.MainControllers;

import einsporn.com.au.DataModel.*;
import einsporn.com.au.DialogBoxControllers.AddCustomerDialogBoxController;
import einsporn.com.au.DialogBoxControllers.EditSelectedItemDiologBoxController;
import einsporn.com.au.Main;
...
public class ShopPageController {
    ...
    public ShopPageController() throws FileNotFoundException {
    }
    ...
    public void initialize() throws SQLException, FileNotFoundException {
        ...
        customerDialogBoxData.retriveSearchSaleProductTableItemsFromDB("", "firstName");
    ...
    @FXML
    public void AddToCustomerBasketBtnHandler() throws SQLException {
    ...
    @FXML
    public void productSearchBtnHandler() {
    ...
    @FXML
    public void RemoveCustomerBtnHandler() {
    ...
    @FXML
    public void EditSelectedItemBtnHandler() throws Exception {
    ...
    @FXML
    public void RemoveSelectedItemBtnHandler() throws Exception {
    ...
    @FXML
    public void SaveBtnHandler() throws Exception {
    ...
    @FXML
    public void emptyCustomerBasketBtnHandler() throws Exception {
    ...
    public void totalPriseAndNoItemsLabelsHandler() {
    ...
    public void setSelectedCutomerLabel() throws SQLException {
