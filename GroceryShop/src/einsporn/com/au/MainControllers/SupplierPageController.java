...
import einsporn.com.au.DataModel.SupplierPageData;
import einsporn.com.au.DialogBoxControllers.AddEditSupplierDialogBoxController;
...
public class SupplierPageController {
    ...
    @FXML
    public void supplierSearchBtnHandler() {
    ...
    @FXML
    public void addEditSupplierBtnsHandler(Event event) throws Exception {
    ...
    @FXML
    public void removeSupplierBtnHandler() throws Exception {
